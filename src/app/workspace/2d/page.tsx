        ...
        >
          ...
          {((isMobile && !mobilePanelOpen) || (!isMobile && rightPanel === "none")) && (
            <button
              ...
              className={`absolute top-3 right-3 z-20 flex items-center gap-1.5 px-3 py-2 rounded-xl shadow-xl border text-xs font-bold transition-all hover:scale-105 ${
                nightMode
                  ? 'bg-zinc-900/95 border-zinc-700 text-primary hover:bg-zinc-800'
                  : 'bg-white/95 border-slate-200 text-primary hover:bg-slate-50'
              }`}
            >
              <Sparkles className="w-4 h-4" />
